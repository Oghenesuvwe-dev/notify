...
func (*Service) LoginWithSessionCredentials(_, _, _, _ string, _, _ []byte) error { return nil }
...
func (*Service) LoginWithQRCode() error { return nil }
...
func (*Service) AddReceivers(_ ...string) {}

// Send takes a message subject and a message body and sends them to all previously set contacts.
func (*Service) Send(_ context.Context, _, _ string) error { return nil }
